...
const Hero = () => {
  ...
  const handleTrack = () => {
    if (!isLoggedIn) {
      navigate("/login", { state: { redirectTo: "/trackorder" } });
    } else {
      navigate("/trackorder");
    }
  };
  ...
  return (
    <div className="container mx-auto px-4 py-12 lg:py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
        <div
          className="bg-white p-6 rounded-lg shadow-md hover:scale-105"
          data-aos="flip-left"
          data-aos-delay="100"
        >
        ...
        <div
          className="bg-white p-6 rounded-lg shadow-md hover:scale-105 duration-150"
          data-aos="flip-left"
          data-aos-delay="200"
        >
          <div className="text-blue-600 text-3xl mb-4">
