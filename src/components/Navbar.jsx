        ...
        <nav className="flex justify-between items-center sticky top-0 w-full shadow-md p-4 px-5 z-50 backdrop-blur">
            ...
            <ul className="hidden md:flex gap-6 text-xl">
                <NavLink
                    className={(e) =>
                        e.isActive
                            ? "border-b-2 border-blue-600 text-blue-600 transition duration-300"
            ...
            <div
                className={`${
                    isOpen ? "block" : "hidden"
                } absolute top-16 left-0 right-0 bg-white md:hidden`}
            >
            ...
            {/* Right Side (User ID and Log out) - Desktop Only */}
            <div className="hidden md:flex items-center gap-4">
                ...
                {isLoggedIn ? (
                    <button
                        className="bg-blue-600 text-white rounded-md px-6 py-2 hover:bg-blue-700 transition duration-300"
                        onClick={logout}
                    >
                        <NavLink to="/login">Log out</NavLink>
                    </button>
